      ...
      <article className="slogan">
          ...
          <div className="slogan__grid" >
            <div className="slogan__grid--item">
              <h2 data-aos="fade-right" data-aos-offset="400">La Mujer<br />mas bella</h2>
            </div>
            <div className="slogan__grid--item">
              <p data-aos="fade-left" data-aos-offset="400">As the years went by, our beauty grew older andeventually time blossomed truth into mystery leaving
