  ...
  render() {
    return (
      <article className="link-page">
        <figure className="link-page--item" data-aos="fade-right" data-aos-offset="400">
        ...
        <figure className="link-page--item" data-aos="zoom-in" data-aos-delay="100" data-aos-offset="400">
        ...
        <figure className="link-page--item" data-aos="fade-left" data-aos-delay="200" data-aos-offset="400">
