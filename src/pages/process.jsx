    ...
    // >
      <div >
        ...
        <section className="section process">
          ...
          <p className="section__title1" data-aos="fade-right" data-aos-offset="300">Curamia, the most beautiful Tequila.</p>

            
          <p className="section__text" data-aos="fade-right" data-aos-offset="300">Curamia’s exceptionally smooth taste —clean, extra-soft, herbal finishes— is a result of our commitment to simplicity and ustainability, as well as authenticity and craftsmanship. Our liquid extraction model is recognized by the tequila regulatory council for its sustainability —utilizing steam and water for the purest taste (and cleanest process) possible. In short, Curamia is as beautiful on the inside as it is on the out— not an easy feat when the packaging is so stylish.</p>
